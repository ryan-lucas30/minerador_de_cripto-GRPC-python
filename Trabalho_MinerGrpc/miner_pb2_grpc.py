...
class MinerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.submitChallenge = channel.unary_unary(
                ...
                request_serializer=miner__pb2.SolutionRequest.SerializeToString,
        ...
        self.getSolution = channel.unary_unary(
                '/Miner/getSolution',
                request_serializer=miner__pb2.TransactionIDRequest.SerializeToString,
                response_deserializer=miner__pb2.SolutionInfoResponse.FromString,
                _registered_method=True)
...
def add_MinerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'submitChallenge': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=miner__pb2.SolutionRequest.FromString,
            ...
            'getSolution': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=miner__pb2.TransactionIDRequest.FromString,
                    response_serializer=miner__pb2.SolutionInfoResponse.SerializeToString,
            ),
    }
...
class Miner(object):
    ...
    def submitChallenge(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Miner/submitChallenge',
            miner__pb2.SolutionRequest.SerializeToString,
    ...
    def getSolution(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/Miner/getSolution',
            miner__pb2.TransactionIDRequest.SerializeToString,
            miner__pb2.SolutionInfoResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
